...
# trivy
RUN curl -LO "https://github.com/aquasecurity/trivy/releases/download/${TRIVY_VERSION}/trivy_${TRIVY_VERSION#v}_Linux-64bit.tar.gz" \
    && tar -zxvf "trivy_${TRIVY_VERSION#v}_Linux-64bit.tar.gz" trivy \
